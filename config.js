...
module.exports = {
  botname: process.env.BotName || "うちは MADARA", 
  author: process.env.Author || "@SHASHANK",
  packname: process.env.PackName || "うちは MADARA",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© うちは MADARA",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "うちは MADARA",
  ownernumber: process.env.Owner_Number || "917019018035",
